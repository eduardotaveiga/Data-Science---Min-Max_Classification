...
from MinMaxClassification.obj_functions_classifiers import SVC_objective_function
...
svc_time_money_test = []
svc_time_money_train = []
svc_money_earned_train = []
svc_money_earned_test = []
for stock in stocks:
    ...
    clf, feature_subset = ModelTraining(train_df, clf, features, objective_function=SVC_objective_function,
    ...
    svc_money_earned_train.append(money_train)
    svc_money_earned_test.append(money_test)
    svc_time_money_train.append(values_train)
    svc_time_money_test.append(values_test)

    print('------------------------------------------------------------------------------------------------------')


data = {'Stock':stocks, 'Train_set':svc_money_earned_train, 'Test_set':svc_money_earned_test}
